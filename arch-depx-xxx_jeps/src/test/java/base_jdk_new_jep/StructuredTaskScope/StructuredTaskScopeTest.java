...
//
//	private static final Logger logger = LoggerFactory.getLogger(StructuredTaskScopeTest.class);
////	// private static final Supplier<ArrayList<String>> supplier = ArrayList::new;
//	StructuredTaskScope<TaskResp, TaskResp> taskScope1 = StructuredTaskScope.open(Joiner.<TaskResp>anySuccessfulResultOrThrow());
//	StructuredTaskScope<TaskResp, Stream<Subtask<TaskResp>>> taskScope2 = StructuredTaskScope.open(Joiner.<TaskResp>allSuccessfulOrThrow());
////	private static final Supplier<StructuredTaskScope.ShutdownOnSuccess<TaskResp>> anySucc = StructuredTaskScope.ShutdownOnSuccess<TaskResp>::new;
////	@SuppressWarnings("preview")
////	private static final Supplier<StructuredTaskScope.ShutdownOnFailure> anyFail = StructuredTaskScope.ShutdownOnFailure::new;
////
////	private static final Supplier<StructuredTaskScope<TaskResp2<TaskReq2>>> anySucc2 = StructuredTaskScope.ShutdownOnSuccess<TaskResp2<TaskReq2>>::new;
////	private static final Supplier<StructuredTaskScope<Object>> anyFail2 = StructuredTaskScope.ShutdownOnFailure::new;
...
//		StructuredTaskScope<TaskResp, Stream<Subtask<TaskResp>>> open = StructuredTaskScope.open(Joiner.<TaskResp>allSuccessfulOrThrow());
