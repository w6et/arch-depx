...
//public class StructuredTaskScopeJdk25Test {
//
//	private static final Logger logger = LoggerFactory.getLogger(StructuredTaskScopeJdk25Test.class);
////	// private static final Supplier<ArrayList<String>> supplier = ArrayList::new;
//	//StructuredTaskScope<T, R>,Subtask<T>\
//	@SuppressWarnings("preview")
//	StructuredTaskScope<Void, Void> taskScope0 = StructuredTaskScope.open(Joiner.<Void>anySuccessfulResultOrThrow());
//	@SuppressWarnings("preview")
...
//		var scope = StructuredTaskScope.open(Joiner.<T>anySuccessfulResultOrThrow())) {
